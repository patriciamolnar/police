...
$(document).ready(function () {
  ...
  // $inputField.on({ blur: validateInput });
  ...
  function getChart(arr) {
    ...
    var $h3 = $(
      '<div><h1 class="heading" style="width:250px;">Your results</h1></div>'
    ).addClass("header");
    ...
    var $other = $(
      '<div><p class="other-resolution">**Other resolutions could be amongst others: a warning, summons or a ' +
